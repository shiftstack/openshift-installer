...
require (
	...
	github.com/gophercloud/gophercloud v0.14.1-0.20201212032044-3647be39edaf
	...
	github.com/terraform-provider-openstack/terraform-provider-openstack v1.33.1-0.20201211173614-494b737724d9
